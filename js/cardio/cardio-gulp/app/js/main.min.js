...
"use strict";const form=document.querySelector(".form"),containerWorkouts=document.querySelector(".workouts"),inputType=document.querySelector(".form__input--type"),inputDistance=document.querySelector(".form__input--distance"),inputDuration=document.querySelector(".form__input--duration"),inputCadence=document.querySelector(".form__input--temp"),inputElevation=document.querySelector(".form__input--climb");navigator.geolocation&&navigator.geolocation.getCurrentPosition((function(t){const{latitude:o,longitude:e}=t.coords}),(function(){alert("Разрешите доступ к местоположению")}));