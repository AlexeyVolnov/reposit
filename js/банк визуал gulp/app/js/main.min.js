...
"use strict";const modalWindow=document.querySelector(".modal-window"),overlay=document.querySelector(".overlay"),btnCloseModalWindow=document.querySelector(".btn--close-modal-window"),nav=document.querySelector(".nav"),btnScrollTo=document.querySelector(".btn--scroll-to"),section1=document.querySelector("#section--1"),tabContainer=document.querySelector(".operations__tab-container"),contentBlock=document.querySelectorAll(".operations__content"),buttons=document.querySelectorAll(".operations__tab"),link=document.querySelector(".nav__links"),header=document.querySelector(".header"),sections=document.querySelectorAll(".section"),section2=document.querySelector("#section--2"),section3=document.querySelector("#section--3"),btnsOpenModalWindow=document.querySelectorAll(".btn--show-modal-window"),openModalWindow=function(e){e.preventDefault(),modalWindow.classList.remove("hidden"),overlay.classList.remove("hidden")},closeModalWindow=function(){modalWindow.classList.add("hidden"),overlay.classList.add("hidden")};btnsOpenModalWindow.forEach((e=>{e.addEventListener("click",openModalWindow)})),btnCloseModalWindow.addEventListener("click",closeModalWindow),overlay.addEventListener("click",closeModalWindow),document.addEventListener("keydown",(function(e){"Escape"!==e.key||modalWindow.classList.contains("hidden")||closeModalWindow()})),link.addEventListener("click",(function(e){if(e.preventDefault(),e.target.classList.contains("nav__link")&&!e.target.classList.contains("btn")){const t=e.target.getAttribute("href");document.querySelector(`${t}`).scrollIntoView({behavior:"smooth"})}})),tabContainer.addEventListener("click",(function(e){const t=e.target.closest(".operations__tab");if(!t)return;buttons.forEach((e=>e.classList.remove("operations__tab--active"))),contentBlock.forEach((e=>e.classList.remove("operations__content--active")));const n=+t.getAttribute("data-tab");document.querySelector(`.operations__content--${n}`).classList.add("operations__content--active"),document.querySelector(`.operations__tab--${n}`).classList.add("operations__tab--active")}));const navLinkHoverAnimation=function(e){const t=e.target;if(t.classList.contains("nav__link")){const e=t.closest(".nav__links").querySelectorAll(".nav__link"),n=t.closest(".nav").querySelector(".nav__logo"),o=t.closest(".nav").querySelector(".nav__text");e.forEach((e=>{e!==t&&(e.style.opacity=this,o.style.opacity=this,n.style.opacity=this)}))}};nav.addEventListener("mouseover",navLinkHoverAnimation.bind(.2)),nav.addEventListener("mouseout",navLinkHoverAnimation.bind(1));const navHeight=nav.getBoundingClientRect().height,getStickyNav=function(e){0===e[0].intersectionRatio&&!1===e[0].isIntersecting?nav.classList.add("sticky"):nav.classList.remove("sticky")},observer=new IntersectionObserver(getStickyNav,{root:null,threshold:0,rootMargin:`-${navHeight}px`});observer.observe(header),sections.forEach((e=>e.classList.add("section--hidden")));const sectionPopUp=function(e,t){const n=e[0];!0===n.isIntersecting&&(n.target.classList.remove("section--hidden"),sectionObserver.unobserve(n.target))},sectionObserver=new IntersectionObserver(sectionPopUp,{root:null,threshold:.2});sections.forEach((e=>sectionObserver.observe(e)));const lazyLoadingImg=document.querySelectorAll("[data-src]")&&document.querySelectorAll(".services__img"),lazyLoading=function(e,t){const n=e[0];n.isIntersecting&&(n.target.src=n.target.dataset.src,n.target.addEventListener("load",(()=>{n.target.classList.remove("lazy-img"),lazyImagesObserver.unobserve(n.target)})))},lazyImagesObserver=new IntersectionObserver(lazyLoading,{root:null,threshold:.7});lazyLoadingImg.forEach((e=>lazyImagesObserver.observe(e)));const sliderContainer=document.querySelector(".slider"),sliderItems=document.querySelectorAll(".slide"),sliderLeftBtn=document.querySelector(".slider__btn--left"),sliderRightBtn=document.querySelector(".slider__btn--right");sliderItems.forEach(((e,t)=>{0!==t&&(e.style.display="none")})),sliderContainer.addEventListener("click",(function(e){e.target.classList.contains("slider__btn--left")&&(e.target.classList.style.display="none",e.target.nextSibling.style.display="block")}));